package edu.ngd.order.equipment.fault.service;

import edu.ngd.order.equipment.fault.entity.EquipmentFaultCode;
import edu.ngd.order.equipment.fault.mapper.EquipmentFaultCodeMapper;
...
public class EquipmentFaultCodeService {
     ...
     * @return 故障代码ID
     */
    public Integer createFaultCode(EquipmentFaultCode faultCode) {
     ...
     * @return 故障代码信息
     */
    public EquipmentFaultCode getFaultCodeById(Integer id) {
     ...
     * @return 影响行数
     */
    public int deleteFaultCodeById(Integer id) {
