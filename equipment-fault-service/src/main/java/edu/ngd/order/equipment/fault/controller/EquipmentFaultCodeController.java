package edu.ngd.order.equipment.fault.controller;
...
import edu.ngd.order.equipment.fault.service.EquipmentFaultCodeService;
...
public class EquipmentFaultCodeController {
     ...
     */
    @PostMapping
    public Result<Integer> createFaultCode(@RequestBody EquipmentFaultCode faultCode) {
        Integer faultCodeId = equipmentFaultCodeService.createFaultCode(faultCode);
     ...
     */
    @GetMapping("/{id}")
    public Result<EquipmentFaultCode> getFaultCodeById(@PathVariable Integer id) {
     ...
     */
    @PutMapping("/{id}")
    public Result<Integer> updateFaultCode(@PathVariable Integer id, @RequestBody EquipmentFaultCode faultCode) {
        faultCode.setId(id);
     ...
     */
    @DeleteMapping("/{id}")
    public Result<Integer> deleteFaultCodeById(@PathVariable Integer id) {
