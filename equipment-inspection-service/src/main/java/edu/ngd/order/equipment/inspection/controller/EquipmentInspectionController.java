...
import edu.ngd.order.equipment.inspection.service.EquipmentInspectionService;
...
public class EquipmentInspectionController {
     ...
     */
    @PostMapping
    public Result<Integer> createInspection(@RequestBody EquipmentInspection inspection) {
        Integer inspectionId = equipmentInspectionService.createInspection(inspection);
     ...
     */
    @GetMapping("/{id}")
    public Result<EquipmentInspection> getInspectionById(@PathVariable Integer id) {
     ...
     */
    @PutMapping("/{id}")
    public Result<Integer> updateInspection(@PathVariable Integer id, @RequestBody EquipmentInspection inspection) {
        inspection.setId(id);
     ...
     */
    @DeleteMapping("/{id}")
    public Result<Integer> deleteInspectionById(@PathVariable Integer id) {
