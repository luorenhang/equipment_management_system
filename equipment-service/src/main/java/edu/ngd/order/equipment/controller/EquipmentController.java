...
import edu.ngd.order.equipment.service.EquipmentService;
...
public class EquipmentController {
    ...
    public Result<Integer> createEquipment(@RequestBody Equipment equipment) {
        try {
            Integer equipmentId = equipmentService.createEquipment(equipment);
     ...
     */
    @PutMapping("/{id}")
    public Result<Integer> updateEquipment(@PathVariable Integer id, @RequestBody Equipment equipment) {
        equipment.setId(id);
     ...
     */
    @DeleteMapping("/{id}")
    public Result<Integer> deleteEquipmentById(@PathVariable Integer id) {
